...
class EasyFetchEnv(robot_env.RobotEnv):
    ...
    def __init__(
        ...
        super(EasyFetchEnv, self).__init__(
...
PICK_AND_PLACE_XML_PATH = os.path.split(robot_env.__file__)[0]
PICK_AND_PLACE_XML_PATH = os.path.join(PICK_AND_PLACE_XML_PATH, 'assets', 'fetch', 'pick_and_place.xml')
class EasyFetchPickAndPlaceEnv(EasyFetchEnv, gym_utils.EzPickle):
    def __init__(self, reward_type='sparse'):
        ...
        EasyFetchEnv.__init__(
            ...
            obj_range=0.01, target_range=0.01, distance_threshold=0.05,
            initial_qpos=initial_qpos, reward_type=reward_type, goal_high_prob=1.0)
        gym_utils.EzPickle.__init__(self)
        self._max_episode_steps = 50


class SuperEasyFetchPickAndPlaceEnv(EasyFetchEnv, gym_utils.EzPickle):
    def __init__(self, reward_type='sparse'):
        initial_qpos = {
            'robot0:slide0': 0.405,
            'robot0:slide1': 0.48,
        ...
        EasyFetchEnv.__init__(
            ...
            obj_range=0.01, target_range=0.01, distance_threshold=0.05,
            initial_qpos=initial_qpos, reward_type=reward_type, goal_high_prob=1.0,
            min_goal_extra_height=0.15, max_goal_extra_height=0.20)
        gym_utils.EzPickle.__init__(self)
        self._max_episode_steps = 55


class TargetOnlyInAirFetchPickAndPlaceEnv(EasyFetchEnv, gym_utils.EzPickle):
    def __init__(self, reward_type='sparse'):
        initial_qpos = {
            'robot0:slide0': 0.405,
            'robot0:slide1': 0.48,
        ...
        #     initial_qpos=initial_qpos, reward_type=reward_type, goal_high_prob=1.0,
        #     min_goal_extra_height=0.1, max_goal_extra_height=0.3)
        # gym_utils.EzPickle.__init__(self)
