...
from rlkit.torch.torch_rl_algorithm import TorchSingleTaskBatchAlgorithm
...
class AdvIRL(TorchSingleTaskBatchAlgorithm):
    '''
        Depending on parameter settings and replay buffer size:
        AIRL, GAIL, FAIRL, Discriminator-Actor-Critic

        Reward-wrapping mentioned in https://arxiv.org/pdf/1809.02925.pdf
        is not implemented
    '''
    def __init__(
        self,
